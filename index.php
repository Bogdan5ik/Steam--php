	...
	<div class="col-12" style="background-color: #212429; height: 100%;">
		<div class="col-8 mx-auto pt-5">
				...
				<form action="profile.php" method="GET">
					...
					<input type="text" name="name" class="w-25 form-control bg-dark" style="color: white;">

					<p class="text-white m-0 mt-3">Электронная почта</p>
					<input type="text" name="email" class="w-25 form-control bg-dark" style="color: white;">
					...
					<a href="profile.php"><button type="submit" class="btn  btn-primary mt-4">Готово</button></a>
